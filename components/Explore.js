          ...
          <DialogContent>
            <View>
              <Pressable onPress={() => {
                ...
                <Text style={{fontFamily: 'Inter'}}>{ pressed ? <Svg xmlns="http://www.w3.org/2000/svg" height={30} viewBox="0 -960 960 960" width={30}>
                    <Path
            ...
            />
              ...
              <Pressable onPress={() => {
                ...
                <Text style={{fontFamily: 'Inter'}}>Many Sizes</Text>
              </Pressable>
            </View>
          </DialogContent>
        </Dialog>
