...
export default function Matches() {
        ...
        async function retrieveMatches() {
            ...
            for (let i = 0; i < users.length; i++) {
                temp.push({
                    ...
                    the_listing_image_of_the_listing_they_liked: results[users[i]]['listings_they_have_liked'][0]['image_links'][0],
    ...
    return (
        ...
        {matches == null ? <Text style={{fontFamily: 'Inter', justifyContent: 'center', textAlign:'center'}}>You have no matches. :( </Text> : matches.map(({ image, profile, posts, the_listing_image_of_the_listing_they_liked }, index) => (
         <Pressable style={styles.matchContainer} key={profile.id} onPress={() => {
             ...
             <View styles={{position: "relative"}} width={80} height={80}>
                ...
                <Image source={{uri: String(the_listing_image_of_the_listing_they_liked)}} width={60} height={60} style={styles.yourClothingPicture}/>
            </View>
